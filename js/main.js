$(document).ready(function() {
	...
	var slider = $( "<div id='slider-fut1'></div>" ).insertAfter( select ).slider({
		...
		change: function(event, ui) { 
			...
			else if (sliderValue == '10000000') {
				progressBar(80, $('#progressBar'));
				$('#increase-fut1').removeClass('btn-disabled');
				$('.max-amount-fut1').fadeOut();
			}
			else if (sliderValue == '50000000') {
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() { 
					$console_message.html("Searching for Player ID <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> ...");	
					progressBarConsole(18, $('#progressBarConsole'));			
				}, 3000 );
				setTimeout(function() { 
					$console_message.html("Connecting to Player ID <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> on <span class='console-message-connected-item'>" + $console_message_platform_msg + "</span> Platform");	
				...
				setTimeout(function() { 
					$console_message.html("Successfully Connected to Player ID <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>");
				...
				//-------------------------------1 Resurs Start-------------------------------//
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> Tennis Clash Coins");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> <span class='console-message-success'>Tennis Clash Coins Generated Successfully</span>");
				...
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_fut2_msg + "</span> Tennis Clash Gems");
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_fut2_msg + "</span> <span class='console-message-success'>Tennis Clash Gems Generated Successfully</span>");
	...
	$('#second-step-button').click(function() {
		if ($('#account-username').val() != '') {
			...
			swal("Error", "Please enter your Player ID.", "error");
		}
	});
